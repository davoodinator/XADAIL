...
robocopy "%BATCH_DIR%DAIL\database" "%BATCH_DIR%DAILmain - AX\database" /S /NFL /NDL *.dbr *.tpl *.lua /xf gameengine.dbr
robocopy "%BATCH_DIR%DAIL\database" "%BATCH_DIR%DAILmain - SX\database" /S /NFL /NDL *.dbr *.tpl *.lua /xf gameengine.dbr
...
robocopy "%BATCH_DIR%DAIL\source\scripts" "%BATCH_DIR%DAILmain - X\source\scripts" /S /NFL /NDL *.dbr *.tpl *.lua
...
robocopy "%BATCH_DIR%DAIL\source\scripts" "%BATCH_DIR%DAILmain - B\source\scripts" /S /NFL /NDL *.dbr
robocopy "%BATCH_DIR%DAIL\assets\scripts" "%BATCH_DIR%DAILmain - B\assets\scripts" /S /NFL /NDL *.dbr
...
robocopy "%BATCH_DIR%DAIL\assets\items" "%BATCH_DIR%DAIL - RIFT\assets\items" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\assets\items" "%BATCH_DIR%DAIL - SURVIVAL\assets\items" /S /NFL /NDL
...
robocopy "%BATCH_DIR%DAIL\assets\wanez-dga" "%BATCH_DIR%DAIL - RIFT\assets\wanez-dga" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\assets\wanez-dga" "%BATCH_DIR%DAIL - SURVIVAL\assets\wanez-dga" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\assets\wanez-runes" "%BATCH_DIR%DAIL - RIFT\assets\wanez-runes" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\assets\wanez-runes" "%BATCH_DIR%DAIL - SURVIVAL\assets\wanez-runes" /S /NFL /NDL
...
robocopy "%BATCH_DIR%DAIL\source\items" "%BATCH_DIR%DAIL - RIFT\source\items" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\source\items" "%BATCH_DIR%DAIL - SURVIVAL\source\items" /S /NFL /NDL
...
robocopy "%BATCH_DIR%DAIL\source\wanez-dga" "%BATCH_DIR%DAIL - RIFT\source\wanez-dga" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\source\wanez-dga" "%BATCH_DIR%DAIL - SURVIVAL\source\wanez-dga" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\source\wanez-runes" "%BATCH_DIR%DAIL - RIFT\source\wanez-runes" /S /NFL /NDL
robocopy "%BATCH_DIR%DAIL\source\wanez-runes" "%BATCH_DIR%DAIL - SURVIVAL\source\wanez-runes" /S /NFL /NDL
