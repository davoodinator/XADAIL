...
function wanez.dga.cPortal(argObjectId)
    ...
    local class = {
        ...
        setFloorRegionCount = function(self,argFloorCount,argRegionCount)
            floorCount = argFloorCount
            regionCount = argRegionCount
        end;
        getFloorRegionCount = function(self)
            return {floorCount,regionCount};
        end;
    }
    return class
end
