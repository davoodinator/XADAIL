...
local oldGroveBridgeStateObjects = orderedTable()
	...
	oldGroveBridgeStateObjects[""] 							 	 	= { state = BridgeState.Destroyed, dbr = "records/storyelements/questassets/waterfrontbridge_broken01.dbr" }
...
local oldGroveBridgeSiteStateObjects = orderedTable()
	oldGroveBridgeSiteStateObjects["GD_OLDGROVEBRIDGE_REPAIRED"] 	= { state = BridgeState.Repaired,  dbr = nil }
...
local oldGroveBridgeBlockerStateObjects = orderedTable()
	...
	oldGroveBridgeBlockerStateObjects[""] 							= { state = BridgeState.Destroyed, dbr = "records/level art/quests/dynamicblocker_invisible.dbr" }
