...
;  File /nonfatal /a /r ".\DAIL\database\"
  ...
  SetOverwrite on
  File /oname=DAIL-crucible.exe ".\DAIL-crucible.exe"
  ...
  SetOverwrite on
  File /oname=Conversations.arc ".\survivalmode\resources\Conversations.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Creatures.arc ".\survivalmode\resources\Creatures.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Custom.arc ".\survivalmode\resources\Custom.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Effects.arc ".\survivalmode\resources\Effects.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=FX.arc ".\survivalmode\resources\FX.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=ingameui.arc ".\survivalmode\resources\ingameui.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Items.arc ".\survivalmode\resources\Items.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File "/oname=Level Art.arc" ".\survivalmode\resources\Level Art.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Maps.arc ".\survivalmode\resources\Maps.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Meshes.arc ".\survivalmode\resources\Meshes.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Quests.arc ".\survivalmode\resources\Quests.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Scripts.arc ".\survivalmode\resources\Scripts.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Sound.arc ".\survivalmode\resources\Sound.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Soundeffects.arc ".\survivalmode\resources\Soundeffects.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Sounds.arc ".\survivalmode\resources\Sounds.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Textures.arc ".\survivalmode\resources\Textures.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=Text_EN.arc ".\survivalmode\resources\Text_EN.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=UI.arc ".\survivalmode\resources\UI.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=wanez-dga.arc ".\survivalmode\resources\wanez-dga.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=wanez.arc ".\survivalmode\resources\wanez.arc"
  SetOutPath "$INSTDIR\mods\survivalmode\resources"
  SetOverwrite on
  File /oname=XPack.arc ".\survivalmode\resources\XPack.arc"


;  File "$INSTDIR\survivalmode\database\DAIL-crucible.exe"
;  File "$INSTDIR\survivalmode\database\DAIL-crucible.exe"
;  File "$INSTDIR\survivalmode\database\DAIL-crucible.exe"
;  ExecWait '"delete" $INSTDIR\survivalmode\database\SurvivalMode.arz.old"'
;  ExecWait '"rename" $INSTDIR\survivalmode\database\SurvivalMode.arz $INSTDIR\survivalmode\database\SurvivalMode.arz.old"'
;  ExecWait '"$INSTDIR\survivalmode\database\DAIL-crucible.exe" $INSTDIR\survivalmode\database\SurvivalMode.arz.old $INSTDIR\survivalmode\database\SurvivalMode.arz"'
