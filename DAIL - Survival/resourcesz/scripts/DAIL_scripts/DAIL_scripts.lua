...
function omega.scripts.summontestboss(objectID)
	local Player = Game.GetLocalPlayer();
	local coords = Player:GetCoords();
	local namedbr ="records/creatures/enemies/boss&quest/"..objectID..".dbr"
	local test = Entity.Create(namedbr);
...
function omega.scripts.killme(objectID)
	local targetEntity = Entity.Get(objectId)
